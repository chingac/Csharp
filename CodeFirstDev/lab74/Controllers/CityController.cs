...
namespace lab74.Controllers
{
    public class CityController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="CityId,CityName,ProvinceCode")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="CityId,CityName,ProvinceCode")] City city)
        {
            if (ModelState.IsValid)
            {
